...
import com.antutilities.salesforce.compare.*;
...
public class TextDiff {
	...
	public Report compare(File oldFile, File newFile) throws Exception {
		...
		String[] lOld = fl.loadDataAsArray(oldFile.getAbsolutePath());
		String[] lNew = fl.loadDataAsArray(newFile.getAbsolutePath());
